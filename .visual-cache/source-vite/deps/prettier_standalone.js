//#region ../egonetics/main/node_modules/prettier/standalone.mjs
...
function En(e, t, u = {}) {
	let o = _a(!1), { start: a, end: s, markerLines: i } = xa(t, e.split(Fn), u), D = t.start && typeof t.start.column == "number", f = String(s).length, d = e.split(Fn, s).slice(a, s).map((c, p) => {
...
//#endregion
export { li as __debug, ci as check, Hn as default, wu as doc, Jn as format, zn as formatWithCursor, fi as getSupportInfo, Pu as util, Mn as version };
