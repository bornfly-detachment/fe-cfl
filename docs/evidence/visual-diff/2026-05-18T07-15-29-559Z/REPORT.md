...
|---|---:|---:|---:|---|---|---|
| /prvse-world | FAIL | 99.105% | 16.987 | prvse-world.source.png | prvse-world.target.png | prvse-world.diff.png |
...
| /free-code | FAIL | 9.585% | 2.911 | free-code.source.png | free-code.target.png | free-code.diff.png |
| /login | PASS | 0.529% | 0.307 | login.source.png | login.target.png | login.diff.png |
