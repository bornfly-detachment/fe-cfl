//#region ../egonetics/main/node_modules/prettier/plugins/html.mjs
...
var Ps = () => {}, ze = Ps;
var Ye = "string", je = "array", St = "cursor", Ae = "indent", ye = "align", Et = "trim", Ne = "group", Le = "fill", Pe = "if-break", Oe = "indent-if-break", Ct = "line-suffix", vt = "line-suffix-boundary", Y = "line", Tt = "label", De = "break-parent", bt = new Set([
	St,
	Ae,
	ye,
	Et,
...
function C(e, t = {}) {
	return D(e), kt(t.expandedStates, !0), {
		type: Ne,
		id: t.id,
		contents: e,
		break: !!t.shouldBreak,
...
function yn(e, t) {
	...
	return r;
	function n() {
		return ce(e) || e.kind === "angularControlFlowBlock" ? !1 : (e.kind === "text" || e.kind === "interpolation") && e.prev && (e.prev.kind === "text" || e.prev.kind === "interpolation") ? !0 : !e.parent || e.parent.cssDisplay === "none" ? !1 : pe(e.parent) ? !0 : !(!e.prev && (e.parent.kind === "root" || pe(e) && e.parent || H(e.parent, t) || Je(e.parent, t) || !ma(e.parent.cssDisplay)) || e.prev && !ga(e.prev.cssDisplay));
	}
}
function Nn(e, t) {
	return ce(e) || e.kind === "angularControlFlowBlock" ? !1 : (e.kind === "text" || e.kind === "interpolation") && e.next && (e.next.kind === "text" || e.next.kind === "interpolation") ? !0 : !e.parent || e.parent.cssDisplay === "none" ? !1 : pe(e.parent) ? !0 : !(!e.next && (e.parent.kind === "root" || pe(e) && e.parent || H(e.parent, t) || Je(e.parent, t) || !fa(e.parent.cssDisplay)) || e.next && !da(e.next.cssDisplay));
}
function Ln(e, t) {
...
function Pn(e) {
	return gr(e) || e.kind === "element" && e.children.length > 0 && ([
		...
		"script",
		"style"
	].includes(e.name) || e.children.some((t) => ca(t))) || e.firstChild && e.firstChild === e.lastChild && e.firstChild.kind !== "text" && Dn(e.firstChild) && (!e.lastChild.isTrailingSpaceSensitive || In(e.lastChild));
}
function gr(e) {
...
function Bn(e, t) {
	...
	switch (t.htmlWhitespaceSensitivity) {
		...
		default: if (e.kind === "element" && (!e.namespace || r || ue(e)) && Object.prototype.hasOwnProperty.call(hr, e.name)) return hr[e.name];
	}
	return bn;
}
function Fn(e) {
...
var Er = (e) => (t, r, n) => x(b(n.node), t, { parser: e }, W), va = [
	{
		test(e) {
...
var wa = new Set([
	...
	"onwaiting",
	"onwheel"
]), Yn = ({ node: e }, t) => wa.has(e.fullName) && !t.parentParser && !e.value.includes("{{"), jn = (e, t, r) => x(b(r.node), e, {
	parser: "babel",
...
function Pa(e) {
	...
	function S() {
		let m = !1, g, E, P, z, le = {}, ee, _t, ke, Ge, nr;
		for (z = 0; z < n.length; z++) ee = n[z], _t = ee[ee.length - 1], ke = ee.substring(0, ee.length - 1), Ge = parseInt(ke, 10), nr = parseFloat(ke), Zn.test(ke) && _t === "w" ? ((g || E) && (m = !0), Ge === 0 ? m = !0 : g = Ge) : La.test(ke) && _t === "x" ? ((g || E || P) && (m = !0), nr < 0 ? m = !0 : E = nr) : Zn.test(ke) && _t === "h" ? ((P || E) && (m = !0), Ge === 0 ? m = !0 : P = Ge) : m = !0;
		if (!m) le.source = {
			value: r,
			startOffset: c
		}, g && (le.width = { value: g }), E && (le.density = { value: E }), P && (le.height = { value: P }), p.push(le);
...
async function li(e, t, r, n) {
	let { left: s, operator: a, right: o } = Ia(b(r.node)), c = G(r, n);
	return [
		C(await x(`function _(${s}) {}`, e, {
...
function st(e, t, r) {
	...
	if (he(n)) {
		...
		return [
			U(n, t),
			L(y.trimEnd(t.originalText.slice(Q(n) + (n.prev && et(n.prev) ? Bt(n).length : 0), i - (n.next && $(n.next) ? de(n, t).length : 0)))),
			V(n, t)
		];
	}
	return r();
...
function xi(e, t, r) {
	...
	if (eo(e) && i.push("} "), i.push("@", n.name), n.parameters && i.push(" (", C(r("parameters")), ")"), !Za(n)) {
		i.push(" {");
		let s = Ai(n);
		n.children.length > 0 ? (n.firstChild.hasLeadingSpaces = !0, n.lastChild.hasTrailingSpaces = !0, i.push(A([v, Re(e, t, r)])), s && i.push(v, "}")) : s && i.push("}");
	}
...
var Vt;
function Ar() {
	return Vt || (Vt = {}, ot(re.HTML, [
		"iframe|srcdoc",
		"*|innerHTML",
		"*|outerHTML"
	]), ot(re.STYLE, ["*|style"]), ot(re.URL, [
		"*|formAction",
		"area|href",
		"a|href",
		"a|xlink:href",
...
var Di = class {};
var ro = "boolean", no = "number", io = "string", so = "object", ao = [
...
})), oo = Array.from(Ii).reduce((e, [t, r]) => (e.set(t, r), e), /* @__PURE__ */ new Map()), Ri = class extends Di {
	constructor() {
	...
	hasElement(e, t) {
		return t.some((r) => r.name === xr.name) || e.indexOf("-") > -1 && (br(e) || wr(e) || t.some((r) => r.name === kr.name)) ? !0 : this._schema.has(e.toLowerCase());
	}
...
function Be(e) {
	return lt || (Mi = new f({ canSelfClose: !0 }), lt = Object.assign(Object.create(null), {
		base: new f({ isVoid: !0 }),
		meta: new f({ isVoid: !0 }),
		area: new f({ isVoid: !0 }),
...
var Mr = (function(e) {
	...
	constructor(e, t, r) {
		...
		this._cursor = r.escapedString ? new Uo(e, n) : new is(e, n), this._preserveLineEndings = r.preserveLineEndings || !1, this._i18nNormalizeLineEndingsInICUs = r.i18nNormalizeLineEndingsInICUs || !1, this._tokenizeBlocks = r.tokenizeBlocks ?? !0, this._tokenizeLet = r.tokenizeLet ?? !0, this._selectorlessEnabled = r.selectorlessEnabled ?? !1;
		try {
			this._cursor.init();
		} catch (i) {
			this.handleError(i);
...
`);
	...
	_getBlockName() {
		...
		return this._attemptCharCodeUntilFn((r) => ct(r) ? !e : Ho(r) ? (e = !0, !1) : !0), this._cursor.getChars(t).trim();
	}
	...
	_getLetDeclarationName() {
		...
		return this._attemptCharCodeUntilFn((r) => Fe(r) || r === 36 || r === 95 || t && ut(r) ? (t = !0, !1) : !0), this._cursor.getChars(e).trim();
	}
...
var N = class os extends ne {
	...
	parse(e, t, r, n = !1, i) {
		...
		} : o, r), p = r && r.canSelfClose || !1, d = r && r.allowHtmComponentClosingTags || !1, S = new Go(u.tokens, a, p, d, n);
...
function Qt(e, t = {}) {
	...
	return $o().parse(e, "angular-html-parser", {
...
function sl(e, t, r) {
	let { node: n } = e;
	switch (n.kind) {
		case "root": return t.__onHtmlRoot && t.__onHtmlRoot(n), [C(Re(e, t, r)), v];
		case "element":
		case "ieConditionalComment": return Pi(e, t, r);
		case "angularControlFlowBlock": return xi(e, t, r);
		case "angularControlFlowBlockParameters": return yi(e, t, r);
		case "angularControlFlowBlockParameter": return y.trim(n.expression);
		...
		case "ieConditionalEndComment": return [Se(n), fe(n)];
		case "interpolation": return [
			Se(n, t),
			...e.map(r, "children"),
			fe(n, t)
...
var er = {
	...
	cases: !0,
	expression: !0
}, Ss = new Set(["parent"]), oe, $r, zr, We = class We {
	constructor(t = {}) {
		tn(this, oe);
		ir(this, "kind");
		ir(this, "parent");
...
function Kr(e, t, r, n = {}) {
	let { frontMatter: i, content: s } = r.shouldParseFrontMatter ? pr(e) : { content: e }, a = new mt(e, n.filepath), o = new qe(a, 0, 0, 0), c = o.moveBy(e.length), { parseOptions: u, rootNodes: p } = t(s, r), d = {
		kind: "root",
		sourceSpan: new h(o, c),
		children: p
	}, S;
...
var wl = gt(rr), kl = new Set(["mj-style", "mj-raw"]), xl = gt({
	...rr,
	name: "mjml",
