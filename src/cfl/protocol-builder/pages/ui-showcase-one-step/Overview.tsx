...
const screenshots: ScreenshotItem[] = [
  ...
  },
  {
    ...
    status: "implemented",
    route: "/ui-showcase-one-step/prompt",
    icon: Sparkles,
  },
  {
    ...
    status: "implemented",
    route: "/ui-showcase-one-step/agent",
    icon: MessageSquare,
  },
  {
    ...
    status: "implemented",
    route: "/ui-showcase-one-step/flow",
    icon: Workflow,
  },
  {
    ...
    status: "implemented",
    route: "/ui-showcase-one-step/board",
    icon: LayoutTemplate,
  },
  {
    ...
    status: "implemented",
    route: "/ui-showcase-one-step/inbox",
    icon: Mail,
  },
  {
    ...
    status: "implemented",
    route: "/ui-showcase-one-step/onboarding",
    icon: GraduationCap,
  },
  {
  ...
  return (
    <div className="min-h-full bg-white p-6 md:p-10">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">UI Showcase One-Step Overview</h1>
          <p className="text-sm text-gray-500 mt-2">
            A curated collection of 20 UI patterns — one-step multimodal generation.
          </p>
        </div>
